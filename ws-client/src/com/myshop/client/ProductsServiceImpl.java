...
public class ProductsServiceImpl extends WebServiceGatewaySupport implements
		ProductsService {

	private static final String MESSAGE =
	        "<GetProductsRequest xmlns=\"http://com/myshop/webservices/getProductsServices\">2</GetProductsRequest>";
	@Override
	...
	public void customSendAndReceive() {
        ...
        getWebServiceTemplate().sendSourceAndReceiveToResult("http://localhost:8085/ws/services",
            source, result);
    }
